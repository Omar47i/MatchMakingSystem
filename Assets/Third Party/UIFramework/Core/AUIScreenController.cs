...
namespace deVoid.UIFramework
{
        ...
        where TProps : IScreenProperties
    {
		...
		/// <summary>
        /// used as a flag to make OnScreenAwake function to be called once only
        /// </summary>
        private bool onAwakeCalled = false;
        ...
        /// <summary>
        /// When this screen is visible, this method is called. Called After OnScreenAwake and OnPropertiesSet
        /// </summary>
		...
		/// <summary>
        /// When this screen is visible for the first time, this method is called. Called at the beginning before OnPropertiesSet
        /// </summary>
