...
namespace deVoid.UIFramework
{
    ...
    public class UISettings : ScriptableObject
    {
        ...
        [HideInInspector]public List<UIData> screens = null;
        ...
        public bool deactivateScreenGOs = true;
        ...
        private void OnValidate() {
            List<UIData> objectsToRemove = new List<UIData>();
            for(int i = 0; i < screens.Count; i++) {
                var screenCtl = screens[i].Prefab.GetComponent<IUIScreenController>();
                if (screenCtl == null) {
                    objectsToRemove.Add(screens[i]);
                }
            }
            ...
            if (objectsToRemove.Count > 0) {
                ...
                foreach (var obj in objectsToRemove) {
                    Debug.LogError("[UISettings] Removed " + obj.ScreenId + " from " + name + " as it has no Screen Controller attached!");
                    screens.Remove(obj);
                }
            }
        }        
