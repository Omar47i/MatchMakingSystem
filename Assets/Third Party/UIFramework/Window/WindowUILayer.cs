...
namespace deVoid.UIFramework
{
    ...
    public class WindowUILayer : AUILayer<IWindowController>
    {
        ...
        public IEnumerable<WindowHistoryEntry> WindowHistory
        {
            get
            {
                if (windowHistory == null) yield break;
                foreach (var window in windowHistory) yield return window;
            }
        }
        ...
        public IEnumerable<WindowHistoryEntry> WindowQueue
        {
            get
            {
                if (windowQueue == null) yield break;

                foreach (var window in windowQueue) yield return window;
            }
        }
        ...
        public override void Initialize() {
            base.Initialize();
            registeredScreens = new Dictionary<ScreenId, IWindowController>();
        ...
        protected override void ProcessScreenRegister(ScreenId screenId, IWindowController controller) {
        ...
        protected override void ProcessScreenUnregister(ScreenId screenId, IWindowController controller) {
            ...
            if (screen == CurrentWindow) {
                ...
                Debug.LogError(
                    string.Format(
                        ...
                        screen.ScreenId, CurrentWindow != null ? CurrentWindow.ScreenId.ToString() : "current is null"));
            }
        }
